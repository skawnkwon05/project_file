...
장소상호작용 = {
    ...
    "학생회관": {
        "상점": [
            {"이름": "두쫀쿠", "가격": 5000, "HP회복": 10},
            {"이름": "카페라떼", "가격": 3000, "HP회복": 5},
        ]
    },
    "스타벅스": {
        "상점": [
            {"이름": "두쫀쿠", "가격": 4000, "HP회복": 10},
            {"이름": "카페라떼", "가격": 2000, "HP회복": 5},
        ]
    },
    "ABMRC": {
        "상점": [
    ...
    "체육관": {"상점": [{"이름": "두쫀쿠", "가격": 7000, "HP회복": 10}, {"이름": "카페라떼", "가격": 4000, "HP회복": 5}]},
    "공학관": {"상점": [{"이름": "두쫀쿠", "가격": 7000, "HP회복": 10}, {"이름": "카페라떼", "가격": 4000, "HP회복": 5}]},
    "공학원": {"상점": [{"이름": "두쫀쿠", "가격": 7000, "HP회복": 10}, {"이름": "카페라떼", "가격": 4000, "HP회복": 5}]},
    "재활병원": {"상점": [{"이름": "두쫀쿠", "가격": 7000, "HP회복": 10}, {"이름": "카페라떼", "가격": 4000, "HP회복": 5}]},
    "어린이병원": {"상점": [{"이름": "두쫀쿠", "가격": 7000, "HP회복": 10}, {"이름": "카페라떼", "가격": 4000, "HP회복": 5}]},
    "중앙도서관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "백양관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "대강당": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "백주년기념관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "안과병원": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "암병원": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "새천년관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "알렌관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "제웅관": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "의과대학": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "치과대학": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "세브란스병원": {"상점": [{"이름": "두쫀쿠", "가격": 6000, "HP회복": 10}, {"이름": "카페라떼", "가격": 3000, "HP회복": 5}]},
    "독수리상": {
        "임무수령": ["임무1", "임무2"]
    },  
    "이윤재관": {
...
임무데이터 = {
    "임무0": {
        "이름": "독수리상 방문",
        "설명": "학교에서 어떤 일들이 일어나고있는지 소식들이 모이는 독수리상에서 알아보자.",
        "완료": False
    },
    "임무1": {
        "이름": "교내 부조리 수사",
        "설명": "교내 어딘가에서 부조리가 일어나고있다. 이동하고 상호작용을 해서 부조리를 찾아서 본관에 보고하라.",
        "완료": False,
        "보고장소": "본관"
    },
    "임무2": {
        "이름": "교내 위생사건 수사",
        "설명": "학생들이 단체로 식중독에 걸렸다. 이동하고 상호작용을 해서 위생사건의 원인을 찾아서 세브란스병원에 보고하라.",
        "완료": False,
        "보고장소": "세브란스병원"
    }
}
...
def 상호작용():
    ...
    # 정문 - 입장
        ...
        if 선택 == "예" or 선택 == "1":
            ...
            print("학교에 입장했다.")
            if "임무0" not in protagonist["임무목록"]:
    ...
    # 본관 - 부조리 수사 보고
        ...
        if 임무데이터[임무키]["완료"]:
            print(f"{임무데이터[임무키]['이름']}은 이미 완료했어.")
            return
    ...
    # 이윤재관 - 최종 보고
    elif "최종보고" in 장소상호작용[현재장소]:
        임무1완료 = 임무데이터["임무1"]["완료"]
        임무2완료 = 임무데이터["임무2"]["완료"]

        if 임무1완료 and not 임무2완료:
            print("부조리 수사를 완료했구나! 식중독 원인도 찾아주세요~")
        elif 임무2완료 and not 임무1완료:
            print("식중독 수사를 완료했구나! 부조리도 찾아주세요~")
        elif 임무1완료 and 임무2완료:
